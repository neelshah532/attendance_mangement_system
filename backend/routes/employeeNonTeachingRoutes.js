...
const { addStudent, updateStudent, addEmployee, updateEmployee, deleteData, addSubjects, updateSubjects, deleteSubject, getSubjects, allocateSubjectsToEmployee, addProgram, deleteProgram, getAllQuery } = require("../controllers/employeeNonTeachingController");
